...
public:
    void print(bool bHeader=false)
    {
        if(bHeader)
        {
        qDebug("TimePlay   Offset Slat Cue  Dur    Name");
        qDebug("---------- ------ ---- ---- ------ ----");
              //1234567890 123456 1234 1234 123456
        }
        qDebug("%10lld %6d %4d %4d %6d %s",
            m_tTimeToPlay,
            m_u32OffsetTime,
            m_u8Slat,
            m_u8Cue,
...
public:
    uint64_t    m_tOrgTimeToPlay; // unadjusted time
